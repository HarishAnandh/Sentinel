...
# These are NOT Razorpay's actual costs.
...
print(
    f"FP cost: ₹{best_cost['fp_cost']:,.0f}"
)

print(
    f"FN cost: ₹{best_cost['fn_cost']:,.0f}"
)

print(
    f"Total estimated cost: ₹{best_cost['total_cost']:,.0f}"
)
...
output_path = DATA_DIR / "rf_threshold_results.csv"
